...
class Block:
    ...
    def mine_block(last_block, data):
        """
        Mine a block based on the given last_block and data, until a block hash that meets the leading 0's proof of work requirement
        """
    ...
    def adjust_difficulty(last_block, new_timestamp):
        ...
        Assures that difficulty is never negative
        """
    ...
    def is_valid_block(last_block, block):
        ...
        if block.hash != reconstructed_hash:
            raise Exception('The block hash must be a correct hash of all its elements')
